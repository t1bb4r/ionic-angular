...
export var Spinner = function () {
    ...
    _createClass(Spinner, [{
        ...
        key: "_updateColor",
        value: function _updateColor(newColor) {
        ...
        key: "_setElementColor",
        value: function _setElementColor(color, isAdd) {
            if (color !== null && color !== '') {
...
__decorate([Input(), __metadata('design:type', String)], Spinner.prototype, "color", null);
...
}), __metadata('design:paramtypes', [typeof (_a = typeof Config !== 'undefined' && Config) === 'function' && _a || Object, typeof (_b = typeof ElementRef !== 'undefined' && ElementRef) === 'function' && _b || Object, typeof (_d = typeof Renderer !== 'undefined' && Renderer) === 'function' && _d || Object])], Spinner);
var SPINNERS = {
    ios: {
        dur: 1000,
        lines: 12,
